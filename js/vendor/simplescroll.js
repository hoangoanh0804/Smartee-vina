    ...
    ($.simplyScroll = function (s, t) {
        ...
        (this.o = $.extend({}, h, t || {})),
            ...
            (this.isForwards =
                ...
                (this.isAuto && null !== this.o.direction.match(/^forwards|backwards$/) && this.o.direction === h.direction)),
        ...
        if (
            ...
            this.isAuto
                ? this.o.pauseButton &&
                  (this.$list.parent().parent().prepend('<div class="simply-scroll-btn simply-scroll-btn-pause"></div>'), (this.o.pauseOnHover = !1))
        ...
        $.simplyScroll.fn.extend({
            init: function () {
                ...
                if (
                    (this.isAuto && "loop" === this.o.autoMode
                        ? (this.$list.css(this.dimension, this.posMax + this.itemMax * s + "px"),
                          ...
                          this.isForwards
                              ? (this.$items.slice(0, s).clone(!0).appendTo(this.$list), (this.resetPosition = 0))
                              : (this.$items.slice(-s).clone(!0).prependTo(this.$list),
                                (this.resetPosition = this.$items.length * this.itemMax),
                                this.isRTL && ((this.$clip[0].dir = "ltr"), this.$items.css("float", "right"))))
                ...
                if (
                    ...
                    if (
                        ...
                        this.o.pauseButton &&
                            (this.$btnPause = $(".simply-scroll-btn-pause", this.$container).bind("click", function (s) {
            ...
            moveStop: function (s) {
                this.movePause(),
                    (this.timestamp = null) !== this.trigger && (void 0 !== s && $(this.trigger).addClass("disabled"), (this.trigger = null)),
